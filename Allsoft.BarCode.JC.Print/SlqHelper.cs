...
namespace Allsoft.BarCode.Print
{/// <summary>
 /// 数据库的通用访问代码
 ...
 /// </summary>
    public abstract class SqlHelper
    {
        ...
        //public static readonly string ConnectionStringLocalTransaction = "Data Source=fwqpc;Initial Catalog=gr_uf_jiekou;Persist Security Info=True;User ID=sa;Password=sql2008";
        ...
        public static void PreparedCommd(SqlConnection con, SqlCommand cmd, string textcmd)
        {
            try
            {
        ...
        public static int ExecuteNonQuery(string textcmd)
        {
            using (SqlConnection con = new SqlConnection(ConnectionStringLocalTransaction))
            {
                SqlCommand cmd = new SqlCommand();
                PreparedCommd(con, cmd, string.Format(textcmd));
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public static object ExecuteScalar(string textmd, SqlParameter[] param)
        {
            using (SqlConnection con = new SqlConnection(ConnectionStringLocalTransaction))
            {
                SqlCommand cmd = new SqlCommand();
                PreparedCommd(con, cmd, textmd);
                return cmd.ExecuteScalar();
            }
        }
        ...
        public static DataTable Table(string sql, SqlParameter[] param)
        {
            SqlConnection con = new SqlConnection(ConnectionStringLocalTransaction);
            con.Open();
            SqlCommand cmd = new SqlCommand(string.Format(sql), con);
